...
{
    class PrintDomTreeAlgorithm : IAlgorithm
    {
        private readonly string _outputFolder;
        private readonly string _graphVizPath;

        public PrintDomTreeAlgorithm(ProgramOptions options)
        {
        ...
        public IList<string> Depedencies => new List<string> { CSA.Artifacts.DomTree };
    }
}