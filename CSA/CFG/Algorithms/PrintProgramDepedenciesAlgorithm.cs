...
{
    class PrintProgramDepedenciesAlgorithm : IAlgorithm
    {
        private readonly string _outputFolder;
        private readonly string _graphVizPath;
        private ProgramDepedencies _programDepecencies;

        public PrintProgramDepedenciesAlgorithm(ProgramOptions options)
        {
            _outputFolder = "program-depedencies";
        ...
        public void Execute()
        {
            ...
            _programDepecencies = Program.Kernel.Get<ProgramDepedencies>();
        ...
        {
            foreach (var link in _programDepecencies[method])
            {
        ...
        public IList<string> Depedencies => new List<string> { CSA.Artifacts.ProgramDepedencies };
    }
}